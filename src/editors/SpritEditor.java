 ...
 * @since July 2009
 */
public class SpritEditor extends javax.swing.JDialog implements EditorInterface {
    ...
    public SpritEditor(java.awt.Frame parent, armadillo_workflow parent_workflow) {
        super(parent, false);
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(NamejTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 225, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        execution_time_TextField.setText("200");
        ...
        jLabel30.setText("Maximum time (in second) to search for transfers");

        mode_ComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Linz ", "Hybrid", "Exhaustive", "Iincorrect conjecture" }));
        ...
        jLabel3.setText("Search mode");

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 51, 51));
        jLabel5.setText("Note: Use a time of 0 for unlimited search time");
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addContainerGap()
                                        .addComponent(mode_ComboBox, 0, 290, Short.MAX_VALUE))
                                    .addGroup(jPanel3Layout.createSequentialGroup()
        ...
        jTabbedPane1.addTab("Sprit", jPanel9);
...
//  better than conjectured mode
    ...
    private void execution_time_TextFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_execution_time_TextFieldFocusLost
       properties.put("execution_time", this.execution_time_TextField.getText());
    ...
    public void setProperties(workflow_properties properties) {
        ...
        if (properties.isSet("mode")) {
         ...
         if (properties.isSet("execution_time")) {
            this.execution_time_TextField.setText(properties.get("execution_time"));
        } 
