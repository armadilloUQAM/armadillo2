 ...
 * @since July 2009
 */
public class dbFetchWebEBIEditor extends javax.swing.JDialog implements EditorInterface {
    ...
    public dbFetchWebEBIEditor(java.awt.Frame parent, armadillo_workflow parent_workflow) {
        super(parent, false);
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(NamejTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 370, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        if (Util.FileExists(config.dataPath()+"//dbFetchDatabase.txt")) {
            String[] str=Util.InputFile(config.dataPath()+"//dbFetchDatabase.txt");
        ...
        else
        {
            ...
            try {
                ...
                Util u=new Util(config.dataPath()+"//dbFetchDatabase.txt");
        ...
        if (properties.isSet("database")) {
            WSDbfetchClient client = new WSDbfetchClient();
            try {
                String[] str=client.getDbFormats(properties.get("database"));
                this.format_jComboBox.removeAllItems();
                for (String  st:str) {
                    this.format_jComboBox.addItem(st);
                }
            } catch(Exception e) {}
        }
        ...
        jLabel9.setText("Note: Only the fasta format will be loaded for Sequence(s).");
        ...
        jLabel8.setText("Note: In case of multiples ID, separate each ones with a comma.");
        ...
        jTabbedPane1.addTab("dbFetchWebEBI", jScrollPane1);
        ...
        if (item.equals("default")) {
           properties.remove("database");
            ...
            //--Download supported format
             WSDbfetchClient client = new WSDbfetchClient();
             try {
                 String[] str=client.getDbFormats(item);
                 this.format_jComboBox.removeAllItems();
                 for (String  st:str) {
                     this.format_jComboBox.addItem(st);
                 }
    ...
    private void Update_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Update_jButtonActionPerformed
         WSDbfetchClient client = new WSDbfetchClient();
             try {
                 ...
                 Util u=new Util(config.dataPath()+"//dbFetchDatabase.txt");
                 this.database_jComboBox.removeAllItems();
                 this.database_jComboBox.addItem("");
                 for (String  st:str) {
    ...
    public void setProperties(workflow_properties properties) {
        ...
        //--Set option (note: some options are set in init)
         if (properties.isSet("ID")) {
            this.jTextArea1.setText(properties.get("ID"));
        }        
