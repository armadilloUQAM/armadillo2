 ...
 * @since July 2009
 */
public class PIRNEditor extends javax.swing.JDialog implements EditorInterface {
    ...
    public PIRNEditor(java.awt.Frame parent, armadillo_workflow parent_workflow) {
        super(parent, false);
    ...
    private void initComponents() {
        ...
        execution_time_TextField = new javax.swing.JTextField();
        ...
        execution_time_TextField.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        execution_time_TextField.setText("0");
        execution_time_TextField.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                execution_time_TextFieldFocusLost(evt);
            }
        });

        jLabel30.setText("Maximum number of reticulation events allowed in network (k) :");

        mode_ComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Exact", "Heuristique (1,000 levels)", "Heuristique (10,000 levels)", "Heuristique (100,000 levels)" }));
        ...
        jLabel5.setText("Note: Use a number of 0 for unlimited reticulation events");
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addContainerGap()
                                        .addComponent(mode_ComboBox, 0, 364, Short.MAX_VALUE))
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addComponent(jLabel30)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(execution_time_TextField, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(103, 103, 103))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel30)
                            .addComponent(execution_time_TextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jLabel5))
                    .addComponent(jSeparator4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 66, Short.MAX_VALUE))
                .addContainerGap())
        );
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jPanel3, javax.swing.GroupLayout.Alignment.LEADING, 0, 391, Short.MAX_VALUE)
        ...
        jTabbedPane1.addTab("PIRN", jPanel9);
...
//  better than conjectured mode
    ...
    private void execution_time_TextFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_execution_time_TextFieldFocusLost
       properties.put("reticulation_events", this.execution_time_TextField.getText());
    }//GEN-LAST:event_execution_time_TextFieldFocusLost
    ...
    public void setProperties(workflow_properties properties) {
        ...
        if (properties.isSet("mode")) {
         ...
         if (properties.isSet("reticulation_events")) {
            this.execution_time_TextField.setText(properties.get("reticulation_events"));
        } 
    ...
    private javax.swing.JTextField execution_time_TextField;
