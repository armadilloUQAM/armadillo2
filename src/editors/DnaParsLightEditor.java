 ...
 * @since July 2009
 */
public class DnaParsLightEditor extends javax.swing.JDialog implements EditorInterface {
    ...
    public DnaParsLightEditor(java.awt.Frame parent, armadillo_workflow parent_workflow) {
        super(parent, false);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Root tree with sequence number");
        ...
        jLabel4.setText("Number of trees to save");

        jComboBox1.setEditable(true);
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10000", "1000", "100", " " }));
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(OutgroupjComboBox, 0, 167, Short.MAX_VALUE)))
        );
        ...
        jTabbedPane1.addTab("DnaPars", jPanel9);
    ...
    private void jComboBox1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jComboBox1FocusLost
        properties.put("trees", (String)this.jComboBox1.getSelectedItem());
    ...
    public void setProperties(workflow_properties properties) {
        ...
        if (properties.isSet("trees")) {
            this.jComboBox1.setSelectedItem(properties.get("trees"));
        }
