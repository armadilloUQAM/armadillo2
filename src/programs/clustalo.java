...
////////////////////////////////////////////////////////////////////////////////
///
/// Create a Thread to run clustal omega (Protein only) - Beta
///
/// Etienne Lord 2011
...
public class clustalo extends RunProgram {
     ...
     */
    public clustalo(workflow_properties properties) {        
        super(properties);
        execute();       
    }
    ...
    public void post_parseOutput() {
             ...
             align.setName("ClustalO ("+Util.returnCurrentDateAndTime()+")");
             ...
             multi.setNote("ClustalO ("+Util.returnCurrentDateAndTime()+")");
