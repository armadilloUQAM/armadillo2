...
//////////////////////////////////////////////////////////////////////////////////////////////33
///
/// Create a Thread to run Phylip protpars
///
/// Etienne Lord 2010
...
public class protpars extends RunProgram {
    ...
    public protpars (workflow_properties properties) {
        super(properties);        
        execute();
    }
   ...
   // FUNCTIONS
    ...
    public void init_createInput() {
       ...
       createConfigFile("protpars.params");
    }
    ...
    public String[] init_createCommandLine() {
        ...
        com[3]="<"+"protpars.params"; //Contient : 0 Y
        return com;
    }
    ...
    public void post_parseOutput() {
            ...
            multi.setNote("Protpars ("+Util.returnCurrentDateAndTime()+")");
            ...
            text.setName("ProtPars outfile at "+Util.returnCurrentDateAndTime());
        ...
        try {
            ...
            if (properties.isSet("outgroup")) {
             ...
             if (properties.isSet("geneticCode")) {
                //Sequence number valid?
                    pw.println("C");
                    pw.println(properties.get("geneticCode").charAt(0));
            }
