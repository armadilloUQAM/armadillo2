...
public class bali_phy_alignmentinfo extends RunProgram {
    ...
    public bali_phy_alignmentinfo(workflow_properties properties) {        
       super(properties);        
       execute();
    }
    ...
    public void post_parseOutput() {
        if (properties.getBoolean("AlignmentInfo")) {
           Results results=new Results(outfile);
            results.setName("BAli-phy results for "+alignment.getName()+" at "+Util.returnCurrentDateAndTime());
