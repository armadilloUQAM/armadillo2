...
public class RenameSequences extends RunProgram {
 ...
 public RenameSequences(workflow_properties properties) {
        super(properties);
        execute();
 }
    ...
    public boolean init_checkRequirements() {
       ...
       if (multiplesequences_id==0&&alignment_id==0) {
           setStatus(this.status_BadRequirements,"Error. No sequences found...");
           return false;
       }
       if (multiplesequences_id!=0&&alignment_id!=0) {
           setStatus(this.status_BadRequirements,"Error. Use only one input at the same time...");
           return false;
       }
       return true;
    }
    ...
    public boolean do_run() throws Exception {
       ...
       if (properties.getBoolean("rename_to_8letters")) {
           ...
           if (m.getId()!=0) {
               ...
               m.saveToDatabase();
               //Config.log(m);
                if (properties.isDebug()) System.out.println(m);
           ...
           if (a.getId()!=0) {
               ...
               a.setId(0);
               a.saveToDatabase();
               if (properties.isDebug()) System.out.println(a);
