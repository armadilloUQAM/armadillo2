...
public class database {
    ...
    public static Connection conn;                          // Connection a la database
    public static Statement stmt;                           // Classe interface a la connection
    public static Statement batch_stmt;                    // Batch statement
    public static PreparedStatement pre_stmt;
    public static ResultSet rs;                            // Pour acc�s facile, on permet public
    public static ResultSetMetaData rsMetaData;            // Pour acc�s facile, on permet public
    public static boolean autocommit=true;                 // Valeur par default
     ...
     */
    public database(boolean autocommit_mode) {
       connect();
    ...
    public boolean connect() {
        ...
        try {
            ...
            batch_stmt.setQueryTimeout(15); //--Time-out to 15 seconds
            pre_stmt = conn.prepareStatement(""); //dummy
            pre_stmt.setQueryTimeout(15);
    ...
    public boolean execute(String command) {
        ...
        try {
             stmt_local=conn.createStatement();
            if (debug) {
