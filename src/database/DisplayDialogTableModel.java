...
public class DisplayDialogTableModel extends AbstractTableModel {
  workflow_properties data=new workflow_properties();
  String[] qualifier={"Type","Value"};
  //private boolean flagChanged=false;                    //Flag to know if this table was changed
  workflow_properties_dictionnary dict=new workflow_properties_dictionnary();
  String[] forbiddenEdition = {"program_id", "param_id","runProgram_id","sequence_id","MultipleSequences_id",
   ...
   public DisplayDialogTableModel() {
   }
   ...
   private void setColumnName() {
    ...
    public boolean isCellEditable(int row, int col) { 
        ...
        for (String s:forbiddenEdition){
            if (key.equals(s)) return false;
        }
        //if (key.equals("sequence_id")) return false;
        return true;
    }
