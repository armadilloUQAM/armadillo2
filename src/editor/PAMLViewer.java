...
public class PAMLViewer extends PApplet implements ChangeListener {
...
//   }
 ...
 public void draw() {
      ...
      if (sequences.getNbSequence()>0) {
            switch(view_mode) {
                case PAMLViewer.VIEW_NORMAL: drawNormal(); break;
                case PAMLViewer.VIEW_BIG: drawDetails(); break;
                case PAMLViewer.VIEW_SMALL: drawSmall();break;
            }
      } else {
          textAlign(CENTER);
