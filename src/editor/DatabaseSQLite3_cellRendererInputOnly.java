 ...
 * @author Etienne Lord
 */
public class DatabaseSQLite3_cellRendererInputOnly extends JPanel implements ListCellRenderer{
    ...
    public DatabaseSQLite3_cellRendererInputOnly(workflow_properties properties) {
        super();
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
       ...
       if (type.equals("Sequence")) {
           if (properties.getInt("input_sequence_id")==0) {
         ...
         if (type.equals("MultipleSequences")) {
           if (properties.getInt("input_multiplesequences_id")==0) {
               this.SelectedElementJLabel.setText("No Elements.");
           } else {
         ...
         if (type.equals("Outgroup")) {
           if (properties.getInt("input_outgroup_id")==0) {
               this.SelectedElementJLabel.setText("No Elements.");
           } else {
         ...
         if (type.equals("Tree")) {
           if (properties.getInt("input_tree_id")==0) {
               this.SelectedElementJLabel.setText("No Elements.");
           } else {
         ...
         if (type.equals("Alignment")) {
           if (properties.getInt("input_alignment_id")==0) {
               this.SelectedElementJLabel.setText("No Elements.");
           } else {
