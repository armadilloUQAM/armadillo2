...
public class DatabaseSQLite3_selection_MultipleSequences_JDialog extends javax.swing.JDialog {
    ...
    public DatabaseSQLite3_selection_MultipleSequences_JDialog(java.awt.Frame parent, workflow_properties properties) {
        super(parent, true);
        this.frame=parent;
        ...
        setIconImage(Config.image);
         DefaultListModel lm=(DefaultListModel)this.jList1.getModel();
          for (Integer id:df.getAllMultipleSequencesID() ) {
              lm.addElement(new InfoMultipleSequences(id));
          }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MultipleSequences");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(Name_jTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 730, Short.MAX_VALUE)
                .addGap(8, 8, 8))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        tmp.put("output_multiplesequences_id", properties.getInt("output_multiplesequences_id"));
        OutputEditor output=new OutputEditor(frame, tmp);
        output.display(tmp);
