...
public class AlignmentViewer extends PApplet implements ChangeListener {
...
//   }
 ...
 public void draw() {
      ...
      if (sequences.getNbSequence()>0) {
            switch(view_mode) {
                case AlignmentViewer.VIEW_NORMAL: drawNormal(); break;
                case AlignmentViewer.VIEW_BIG: drawDetails(); break;
                case AlignmentViewer.VIEW_SMALL: drawSmall();break;
            }
      } else {
          textAlign(CENTER);
...
public void init(MultipleSequences sequences, int w, boolean funcQ) {
    this.sequences=sequences;
    this.setProtein(sequences.isAA());
    //this.wsize=w-20;
    this.wsize=400;
