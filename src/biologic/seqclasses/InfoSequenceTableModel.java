...
public class InfoSequenceTableModel extends AbstractTableModel {
   public Vector<InfoSequence> data=new Vector<InfoSequence>();
   
   String[] qualifier={"Selected for Grouping","Name", "Abbreviate","ID", "Len (bp)"};

   public InfoSequenceTableModel() {
   }
           ...
           if (d!=null) {
               try {
                   switch (col) {
                       ...
                       case 2: return d.getAbbreviate();
                       case 3: return d.getAccession();
                       case 4: return d.getLen();
                       default: return "";
                   }
        ...
        InfoSequence d = data.get(row);
         ...
         switch(col) {
             ...
             case 1 : String s=(String)value;
                      ...
                      break;
             case 2 : String s2=(String)value;
                        if (!s2.equals(d.getAbbreviate())) {
                              d.setAbbreviate(s2);
                              d.setModified(true);
                        }
                      break;
