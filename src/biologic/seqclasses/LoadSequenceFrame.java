 ...
 * @since July 2009
 */
public class LoadSequenceFrame extends javax.swing.JFrame {

    static LoadSequenceFrame main;                       //This is this mainframe gui
    ...
    public LoadSequenceFrame(int mode) {
        initComponents();
    ...
    private void initComponents() {
        ...
        ImportFromDisk_jMenuItem = new javax.swing.JMenuItem();
        SearchWebDB_jMenuItem = new javax.swing.JMenuItem();
        DownloadAccessionList_jMenuItem = new javax.swing.JMenuItem();
        ...
        BatchjMenuItem = new javax.swing.JMenuItem();
        ...
        jPanel29.setBorder(javax.swing.BorderFactory.createTitledBorder("Sequences and informations"));

        jScrollPane1.setBackground(new java.awt.Color(255, 255, 255));
        jScrollPane1.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);

        jTable1.setAutoCreateRowSorter(true);
        jTable1.setModel(new InfoSequenceTableModel());
        ...
        ImportFromDisk_jMenuItem.setText("Import from disk");
        ImportFromDisk_jMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ImportFromDisk_jMenuItemActionPerformed(evt);
            }
        });
        jMenu1.add(ImportFromDisk_jMenuItem);

        SearchWebDB_jMenuItem.setText("Import from Internet");
        SearchWebDB_jMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SearchWebDB_jMenuItemActionPerformed(evt);
            }
        });
        jMenu1.add(SearchWebDB_jMenuItem);

        DownloadAccessionList_jMenuItem.setText("Import list of Accession or Gi");
        DownloadAccessionList_jMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DownloadAccessionList_jMenuItemActionPerformed(evt);
            }
        });
        jMenu1.add(DownloadAccessionList_jMenuItem);

        jMenuItem3.setText("Add new sequence");
        ...
        jMenuItem1.setText("Save selected sequences");
        ...
        BatchjMenuItem.setText("Batch rename sequences");
        BatchjMenuItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BatchjMenuItemActionPerformed(evt);
            }
        });
        jMenu2.add(BatchjMenuItem);
...
//        }
        ...
        String msg="<html>Do you really want to remove "+getNumberSelected()
                +" sequences from database?</html>";
        Object[] options = {"Yes","Cancel"};
        int choice = JOptionPane.showOptionDialog(this,msg,"Warning! Remove Sequence from Project",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE,null,options, options[0]);
        //choice==0 [YES] We remove
        if (choice==0) {
            //Case 1: we remove the current displayed selected sequence            
            for (InfoSequence s:MultipleInfoSequence) if (s.isSelected()) s.setSelected_for_remove(true);
            //Actual remove
            Vector<InfoSequence> toRemove=new Vector<InfoSequence>();
            for (int i=MultipleInfoSequence.size()-1;i>-1;i--) {
                InfoSequence s=MultipleInfoSequence.get(i);
                if (s.isSelected_for_remove()) {
                    toRemove.add(s);
                }
            }
            RemoveSequences(toRemove);
...
//                Message(msg,"",this.jStatusMessageSequence);
    ...
    private void SearchWebDB_jMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchWebDB_jMenuItemActionPerformed
        searchWebDB();
}//GEN-LAST:event_SearchWebDB_jMenuItemActionPerformed

    private void ImportFromDisk_jMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ImportFromDisk_jMenuItemActionPerformed
        importSequenceFromDisk();
      
}//GEN-LAST:event_ImportFromDisk_jMenuItemActionPerformed
    ...
    private void DownloadAccessionList_jMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DownloadAccessionList_jMenuItemActionPerformed
        InputAccessionJDialog dialog=new InputAccessionJDialog(this, true);
        if (dialog.isDownload()) this.ImportSelectedSequenceInternet(dialog.getAccession(), dialog.getCollectionName(), dialog.getComments());
}//GEN-LAST:event_DownloadAccessionList_jMenuItemActionPerformed
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
       SimpleInputJDialog si=new SimpleInputJDialog(this, true, "MultipleSequences");
       if (si.isAdded()) this.loadInfoSequences();
    ...
    private void RemoveFromGroupSequence_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveFromGroupSequence_jButtonActionPerformed
        ...
        if (searchString.startsWith("Alignment:")) {
               ...
               //--Get the ID
                ...
                Vector<Integer> resultIndex=df.getSequenceIDinAlignment(ID);
                Alignment multi=new Alignment(ID);
                for (InfoSequence S:MultipleInfoSequence) {
                    if (resultIndex.contains(S.getId())&&S.isSelected()) {
                        multi.removeSequence(S.getId());
                    } else tm.addData(S);
    ...
    private void BatchjMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BatchjMenuItemActionPerformed
        BatchRenameJDialog batch=new BatchRenameJDialog(this);
        int choice=batch.display();
        InfoSequenceTableModel tm=(InfoSequenceTableModel)this.jTable1.getModel();
        //--Cancelled
        if (choice==99) return;
        ...
        //What do we do?
        int[] index=this.jTable1.getSelectedRows();
        //CASE 1. Use only selected for grouping
        if (index.length==0) {
             //CASE 2. Perform action
            Pattern p_parenthesis=Pattern.compile("\\((.*)\\)");
            Pattern p_bracket=Pattern.compile("\\[(.*)\\]");
            for (int i=0; i<tm.data.size();i++) {
                int j=this.jTable1.convertRowIndexToModel(i);
                String name=tm.data.get(i).getName();
                if (tm.data.get(j).isSelected_for_grouping()||tm.data.get(j).isSelected())
                    switch(choice) {
                            //InsideParenthesis=1;
                            case 1:
                                  Matcher m=p_parenthesis.matcher(name);
                                    if (m.find()) {
                                        tm.data.get(j).setName(m.group(1).replaceAll("\\.", "_").replaceAll("\\s", "_"));
                                        tm.data.get(j).setModified(true);
                                    }
                            break;
                            //InsideBracket=2;
                            case 2:
                                    m=p_bracket.matcher(name);
                                    if (m.find()) {
                                        tm.data.get(j).setName(m.group(1).replaceAll("\\.", "_").replaceAll("\\s", "_"));
                                        tm.data.get(j).setModified(true);
                                    }
                            ...
                            //UseID=3;
                            case 3:
                                   tm.data.get(j).setName(tm.data.get(j).getAccession());
                                   tm.data.get(j).setModified(true);
                            break;
                            //TrimToNineCharacters=4
                            case 4:
                                        tm.data.get(j).setName((name.length()>9?name.substring(0, 8):name));
                                        tm.data.get(j).setModified(true);
                             break;
                            //UseAbbreviate=5;
                            case 5:
                                tm.data.get(j).setName(tm.data.get(j).getAbbreviate());
                                   tm.data.get(j).setModified(true);

                            break;
                            //RemoveToUnderScore=6
                            case 6:
                              tm.data.get(j).setName(name.trim().replaceAll("\\.", "_").replaceAll("\\s", "_"));
                               tm.data.get(j).setModified(true);
                            break;
            ...
            for (int i:index) {
                ...
                switch(choice) {
                        ...
                        case 1:
                              Matcher m=p_parenthesis.matcher(name);
                                if (m.find()) {
                                    tm.data.get(i).setName(m.group(1).replaceAll("\\.", "_").replaceAll("\\s", "_"));
                                    tm.data.get(i).setModified(true);
                                }
                        break;
                        //InsideBracket=2;
                        case 2:
                        ...
                        //UseID=3;
                        case 3:
                               tm.data.get(i).setName(tm.data.get(i).getAccession());
                               tm.data.get(i).setModified(true);
                        break;
                        //TrimToNineCharacters=4
                        case 4:
                                    tm.data.get(i).setName((name.length()>9?name.substring(0, 8):name));
                                    tm.data.get(i).setModified(true);
                         break;
                        //UseAbbreviate=5;
                        case 5:
                            tm.data.get(i).setName(tm.data.get(i).getAbbreviate());
                               tm.data.get(i).setModified(true);

                        break;
                        //RemoveToUnderScore=6
                        case 6: 
                          tm.data.get(i).setName(name.trim().replaceAll("\\.", "_").replaceAll("\\s", "_"));
                        break;
    ...
    }//GEN-LAST:event_BatchjMenuItemActionPerformed
...
/// JTable1
    ...
    void displaySelectedSequence() {
        ...
        InfoSequenceTableModel lm = (InfoSequenceTableModel)this.jTable1.getModel();
        InfoSequence tmp=lm.getInfoSequence(selection);
    ...
    public void saveSelection() {
        ...
        if (result==JFileChooser.APPROVE_OPTION) {
             ...
             for (int indexInfoSequence:indexSelection) {
                 InfoSequence info=tm.getInfoSequence(indexInfoSequence);
                 Sequence     s=new Sequence(info.getId());
                 mus.add(s);
             }
             if (filename.endsWith("phy")||filename.endsWith("phylip")) {
                 if (mus.outputPhylip(filename)) {
                     Message("Saved "+mus.getNbSequence()+" sequence(s) to "+filename+" in Phylip non-interleaved format","",this.jStatusMessageSequence);
                 } else {
                     MessageError("Unable to save "+mus.getNbSequence()+" sequence(s) to "+filename+" in Phylip non-interleaved format","",this.jStatusMessageSequence);
                 }
              } else {
                 if (mus.outputFasta(filename)) {
                    Message("Saved "+mus.getNbSequence()+" sequence(s) to "+filename+" in Fasta format","",this.jStatusMessageSequence);
                 } else {
                     MessageError("Unable to save "+mus.getNbSequence()+" sequence(s) to "+filename+" in Fasta format","",this.jStatusMessageSequence);
                 }
              } //End else
...
//            else {
                for (InfoSequence s:MultipleInfoSequence) if (s.isSelected()) s.setSelected_for_grouping(true);
//            }

        StandardInputSequenceJDialog jd=new StandardInputSequenceJDialog(this, "New_Group_"+this.hashCode(),"Create", "");
        jd.setVisible(true);
        if (jd.getStatus()==Config.status_done) {
            MultipleSequences multi=new MultipleSequences();
            if (jd.getBiologicType().equals("Alignment")){
                multi=new Alignment();
            } else {
            ...
            for (InfoSequence s:MultipleInfoSequence) s.setSelected_for_grouping(false);
            multi.saveToDatabase();
            updateUI();
        }
    }

    public void searchWebDB(){
        SearchGenbank sgb= new SearchGenbank(this);
        if (sgb.getStatus()==SearchGenbank.status_import) {
            ImportSelectedSequenceInternet(sgb.getSequences(), sgb.lastSearch+" on "+Util.returnCurrentDateAndTime(), "Downloaded on "+Util.returnCurrentDateAndTime());
        } 
    }
                ...
                while (!isCancelled()&&toLoad.size()>0) {
                    ...
                    if (!filename.toLowerCase().endsWith("fasta")) {
                        ...
                        try {
                         int outid= BioseqFormats.formatFromName("fasta");
                            ...
                            Config.log("Unable to read "+realname+" using ReadSeq...");
                        }
                        filename="out.fasta";
                    }                   
                  ...
                  try {
                     ...
                     //Process :: We read like a fasta file
                      Config.log("Reading fasta: "+realname);
                      ...
                      br.close();                      
                         ...
                         //--Remove Sequence size if found
                                for (Sequence s:multi.getSequences()) {
                                    Matcher m=multi.seq_size_artefact.matcher(s.getName());
                                    if (m.find()) {                                        
                                        s.setName(m.group(1));
                                    }
                                }
                   ...
                   } catch(Exception e) {e.printStackTrace();Config.log("Error with "+realname);}
                    Config.log("done.");
                   publish("Saving to database...");
                    multi.saveToDatabase();
                    setProgress((totalToLoad-toLoad.size())*100/totalToLoad);
                    if (multi.getId()==0) {
                        publish("Unable to load sequence(s) from "+realname);
                    } else {
                        publish("Successfully imported sequence(s) from "+realname);
                    }
                 }
                return 0;
            }
...
private boolean ImportSelectedSequenceInternet(Vector<InfoSequence> result, final String groupName, final String comments) {
        final Downloader bio = new Downloader(); //Biologic object to assist in downloding
        final MultipleSequences multi=new MultipleSequences();
        ...
        final int MultipleSequenceId = df.getNextMultipleSequencesID();
        final LinkedList<efetch> toload=new LinkedList<efetch>();


        //1. Clean result we don't want
        //Normally done but to be sure
        //Normally, handle ensembl here?
        for (int i=result.size()-1; i>-1; i--) {
            InfoSequence tmp=result.get(i);
            if (!tmp.isSelected()||(tmp.getGi().equals("")&&tmp.getType()!=InfoSequence.type_Ensembl)) {
                result.remove(i);
            } else {
                //Check if we need to download HGNC with Ensemble
                //if (tmp.getType()==InfoSequence.type_Ensembl) loadingIconType=InformationJDialog.mode_Ensembl;
                if (tmp.getType()==InfoSequence.type_HGNC&&ask_for_download_hgnc_from_ensembl){
                    ask_for_download_hgnc_from_ensembl=false;
                    String msg="<html>You have searched files from local HGNC (ex. for "+tmp.getHgncid()+" "+tmp.getDescription()+
                                " )<br>Do you want to download all sequence from Ensembl or from Ncbi?</html>";
                    Object[] options = {"Download All from Ncbi","Download All from Essembl"};
                    int n = JOptionPane.showOptionDialog(this,msg,"Warning! Download HGNC data from Ncbi or Ensembl",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE,null,options, options[0]);
                    switch (n) {
                        //0. All Ncbi: default
                        case 0: break;
                        //1. All Ensembl
                        case 1: download_hgnc_from_ensembl=true;
                                //loadingIconType=InformationJDialog.mode_Ensembl;
                    }
                }
            }

        }
       //1.5 Before we begin, what do we do if we have the file?
        boolean changed=false;
        boolean always_load_current=false;
       for (int i=result.size()-1; i>-1; i--) {
           ...
           if (search.getType()==InfoSequence.type_Ensembl) search.setFastaFilename(search.getEnsemblFilename());
           search.findFile();


           if (!efetch.force_download) {
                 if (search.isFound()) {
                               //Dialog here
                                if (!always_load_current) {
                                String msg="<html>Warning, we already have on disk the files for "+search.getAccession()+" "+search.getDescription()+
                                            "<br>Do you want to download?</html>";
                                Object[] options = {"Yes","Always Download","Skip and Load current", "Always Load current files"};
                                    int n = JOptionPane.showOptionDialog(this,msg,"Warning! Files exists for "+search.getAccession(),JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE,null,options, options[2]);
                                    switch (n) {
                                        //YES. DOWNLOAD
                                        case 0: break;
                                        //YES. ALWAYS DOWNLOAD
                                        case 1: efetch.force_download=true;
                                                do_force_download=true;
                                                break;
                                        //NO. LOAD CURRENT
                                        case 2: search.setSelected(false);
                                                MultipleSequences multi2=new MultipleSequences(search.getFastaFilename());
                                                for (Sequence S:multi2.getSequences()) multi.add(S);
                                                changed=true;
                                                result.remove(i);
                                                break;
                                        case 3: always_load_current=true;
                                    } //End switch
                                } //End !always_load_current
                                if (always_load_current) {
       ...
       //Table changed... Update before we start
       if (changed) {
             updateUI();
        }
        ...
        for (InfoSequence i:result)
            if (i.isSelected()) queue.add(i);

        //3. LAST VARIABLE BEFORE WE START
        final int total_to_download=queue.size()*(config.getBoolean("download_genbank")?3:2);          //Number of file to download
       ...
       @Override
        protected Integer doInBackground() throws Exception {
            ...
            while (!isCancelled()&&(queue.size()>0||download.size()>0)) {
                    ...
                    if (download.size()<maxload&&queue.size()>0) {
                       ...
                       if (search.getType()==InfoSequence.type_Ncbi||(search.getType()==InfoSequence.type_HGNC&&!download_from_ensembl)) {
                            efetch.database=search.getGenbankdb();
                            ...
                            download.add(fasta);
                            if (config.getBoolean("download_genbank"))download.add(genbank);
                       }
                       if (search.getType()==InfoSequence.type_Ensembl||(search.getType()==InfoSequence.type_HGNC&&download_from_ensembl)) {
                           efetch ensembl=bio.getEnsemblFile(search.getEnsemblid(), search.getEmsembldb(), search.getEnsemblFilename());
                           ensembl.setInfo(search);
                           download.add(ensembl);
                       }
                    }
            ...
            while (!isCancelled()&&toload.size()>0) {
                   ...
                   for (Sequence S:tmpm.getSequences()) {
                    ...
                    if (tmpm.getNbSequence()!=0) {
                           publish("Done loading in "+(System.currentTimeMillis()-timestat)+" ms");
                    } else {
                    //CASE 1.2. Error
                        publish("Error loading "+tmp.getInfo().getDescription()+" from "+tmp.getInfo().getFastaFilename());
                    }
                    Util.CleanMemory();
           ...
           @Override
           protected void done(){
                               // We load each sequence that don't hava a real sequence
               //Set force download setting for final
               multi.setName(groupName);
               multi.setNote(comments);
               multi.saveToDatabase();
        ...
        //Finally. Show a load dialog :: Warning Work-In-Progress
        loading=new InformationJDialog(this, false, loadSwingWorker2,"Downloading sequence");
        loading.setProgress(0); //Put 0% as the start progress
...
/// UI and Selection 
 ...
 private void loadInfoSequences() {
      MultipleInfoSequence.clear();
      final Vector<Integer>sequence_id=df.getAllSequenceID();
      final int size=sequence_id.size();
      SwingWorker<Integer, InfoSequence> infoSwingWorker=new SwingWorker<Integer, InfoSequence>()  {

       @Override
        protected Integer doInBackground() throws Exception {
        try {
            for (int i=0; i<size;i++) {
               InfoSequence info=new InfoSequence(sequence_id.get(i));
               publish(info);
        ...
        loading=new InformationJDialog(this, false, infoSwingWorker, "Loading sequence");
        loading.setProgress(0); //Put 0% as the start progress
        loading.Message("Loading "+size+" sequence information from database...", "");
        infoSwingWorker.execute();
    }

 private void updateInfoSequences() {
      ...
      SwingWorker<Integer, InfoSequence> infoSwingWorker=new SwingWorker<Integer, InfoSequence>()  {
       ...
       @Override
        protected Integer doInBackground() throws Exception {
           int size=MultipleInfoSequence.size();
           int count=0;
           try {
               for (InfoSequence info:MultipleInfoSequence) {
                if (info.isModified()) {
                   info.update();
                }
        ...
        loading=new InformationJDialog(this, false, infoSwingWorker, "Updating sequences");
        loading.setProgress(0); //Put 0% as the start progress
        loading.Message("Updating sequence information in database...", "");
        infoSwingWorker.execute();
    }

 private void RemoveSequences(final Vector<InfoSequence> toRemove) {
      ...
      SwingWorker<Integer, InfoSequence> infoSwingWorker=new SwingWorker<Integer, InfoSequence>()  {
       ...
       @Override
        protected Integer doInBackground() throws Exception {
            ...
            for(int i=0; i<size;i++) {
                InfoSequence tmp=toRemove.get(i);
            ...
            @Override
            protected void process(List<InfoSequence> chunks) {
                for (InfoSequence tmp:chunks) MultipleInfoSequence.remove(tmp);
            }
...
public void updateUI() {
    ...
    Message("Currently "+MultipleInfoSequence.size()+" sequences in database.","", this.jStatusMessageSequence);
    ...
    */
    Vector<Integer> search (String regex, int mode) {
        ...
        switch (mode) {
            ...
            case MODE_ALL:      lastSearch="All with: "+regex;
                                for (int i=0; i<MultipleInfoSequence.size();i++) {
                                    InfoSequence data=MultipleInfoSequence.get(i);
                                    Matcher m1 = p.matcher(data.getAccession());
                                    Matcher m2 = p.matcher(data.getGi());
                                    Matcher m3 = p.matcher(data.getName());
                                    Matcher m4 = p.matcher(data.getNote());
                                    Matcher m5 = p.matcher(String.valueOf(data.getLen())); //TO DO: Sequence search
                                    if (m1.find()||m2.find()||m3.find()||m4.find()||m5.find()) returnArray.add(i);
                                }
        } //end switch
    ...
    public void display() {
        ...
        //--Reload sequence if no sequences loadded or new sequence added...
         if (MultipleInfoSequence.size()==0||MultipleInfoSequence.size()!=s.getAllId().size()) loadInfoSequences();
         setVisible(true);
    }
    ...
    private javax.swing.JMenuItem BatchjMenuItem;
    private javax.swing.JButton Close_jButton;
    private javax.swing.JMenuItem DownloadAccessionList_jMenuItem;
    private javax.swing.JComboBox Filter_ComboBox;
    private javax.swing.JMenuItem ImportFromDisk_jMenuItem;
    ...
    private javax.swing.JMenuItem SearchWebDB_jMenuItem;
