...
public class InfoSequenceTableModel2 extends AbstractTableModel {
   public Vector<InfoSequence> data=new Vector<InfoSequence>();
   
   String[] qualifier={"Name", "Abbreviate","ID", "Len (bp)"};

   public InfoSequenceTableModel2() {
   }
