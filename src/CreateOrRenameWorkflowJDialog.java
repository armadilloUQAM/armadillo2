 ...
 * @since July 2009
 */
public class CreateOrRenameWorkflowJDialog extends javax.swing.JDialog {

    ////////////////////////////////////////////////////////////////////////////
    /// Variables

    private String oldPropertiesName="";    //Old properties filename
    public String projectName="";        //New properties filename
    ...
    public CreateOrRenameWorkflowJDialog(java.awt.Frame parent, String oldPropertiesName, String RenameButtonText) {
        super(parent, true);
        this.oldPropertiesName=oldPropertiesName;
        this.frame=parent;
        initComponents();
        setIconImage(Config.image);    
        this.RenamejButton.setText("<html><b>"+RenameButtonText+"</b></html>");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html>New project filename (Will be in the <b>Projects</b> directory)</html>");
        ...
        RenamejButton.setText("<html><b>Create</b></html>");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(jStatusMessage, javax.swing.GroupLayout.DEFAULT_SIZE, 352, Short.MAX_VALUE)
                        .addGap(135, 135, 135)
    ...
    private void renameProperties() {
        projectName=properties_jTextField.getText();
        //--Note: we exit only if everything is fine
        // CASE 1. Empty
        if (projectName.isEmpty()) {
            MessageErreur("Warning, project name cannot be empty!","");
            return;
        }
        
        // CASE 2. Test if endsWith '.db'
        if (!projectName.endsWith(".db")) {
            projectName+=".db";
        }
        //CASE 3. Test if the file exists already

        File file=new File(config.projectsDir()+File.separator+projectName);
        if (file.exists()) {
            MessageErreur("Warning, project already exists! "+projectName,"");
            return;
        }
