	...
	using namespace std;
	// This is a dummy program to write to stdout for testing
	
	 const string wordList[2894] = {
	...
	int main(int argc, char **argv) {
		...
		cout << "Dummy v0.1"<<endl;
		cout<< "Usage: dummy.exe [number of lines]"<<endl;
		if (argc>1) {
			int total=atoi(argv[1]);
			for (int i=0; i<total;i++) {
				  string word = wordList[rand() % 2894];
				 cout << word << endl;
			}
		} else {
			for (int i=0; i<100;i++) {
